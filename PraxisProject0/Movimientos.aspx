<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movimientos.aspx.cs" Inherits="PraxisProject0.Movimientos" %>
        ...
        <script>
            ...
            function append_json(data) {
                ...
                try {
                    ...
                    '<th onclick="sortTable(0)"><span class="glyphicon glyphicon-sort"></span>id</th>' +
                     '<th onclick="sortTable(0)"><span class="glyphicon glyphicon-sort"></span>Fecha</th>' +
                    '<th onclick="sortTable(1)"><span class="glyphicon glyphicon-sort"></span>Destinatario</th>'+
                    '<th onclick="sortTable(2)"><span class="glyphicon glyphicon-sort"></span>Punto de Partida</th>' +
                     '<th onclick="sortTable(0)"><span class="glyphicon glyphicon-sort"></span>Punto de Llegada</th>' +
                     '<th onclick="sortTable(0)"><span class="glyphicon glyphicon-sort"></span>Ver Guía</th>' +
                    '</tr>'
                    ...
                    data.d.forEach(function (object) {
                        ...
                        '<td>' + object.id + '</td>' +
                         '<td>' + object.fecha + '</td>' +
                         '<td>' + object.Destinatario + '</td>' +
                         '<td>' + object.PuntodePartida + '</td>' +
                         '<td>' + object.PuntodeLlegada + '</td>' +
                         '<td><a href="GuiaMovimiento.aspx?Codigo=' + object.id + '"> Ver Guía </a></td> ' 
...
<body>
    ...
    <div  id="titulo" class="row" align="center">
        <div class="col-12">
           ...
           <img align="center"  height="30"   runat="server" id="ImgFoto" src="ArrowCross.svg.png" alt="Foto" border="0" />Movimientos</div>
     </div>
        ...
        <div class="row" align="center">
            <div class="col-2" ></div>
             <div class="col-8" >
                 ...
                 <asp:Button style="background-color:#071456;color:white" ID="Button1" runat="server" Text="Insertar Movimiento"   PostBackUrl="~/InsertarMovimiento.aspx"  />
