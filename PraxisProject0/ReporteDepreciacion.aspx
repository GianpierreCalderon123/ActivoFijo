<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDepreciacion.aspx.cs" Inherits="PraxisProject0.ReporteDepreciacion" %>
    ...
    <form id="form1" runat="server">
      ...
      <div  id="titulo2" class="row" >
        ...
        <div class="row" align="center">
            ...
            <div class="col-4">
                <label id="r">Reporte de Depreciación</label>
            </div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
           ...
           <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="VerReporteDepreciacion.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="VacunaProject0.PraxyEcologyDataDataSetTableAdapters.VerDepreciacionTotalTableAdapter"></asp:ObjectDataSource>
