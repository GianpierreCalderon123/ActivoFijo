<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerMantenimiento.aspx.cs" Inherits="PraxisProject0.VerMantenimiento" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1 id="titulo">Generación de Mantenimientos</h1>
    ...
    <div class="row">
        ...
        <div class="col-2"><input id="Codigo"  readonly="true" class="form-control input-sm" /></div>
        <div class="col-2">Descripcion</div>
        <div class="col-2"><input id="descripcion" readonly="true"  class="form-control input-sm" /></div>
                <div class="col-4" ><button style="background-color:#071456;color:white;width:100%"
        ...
        <br />
          ...
          <div class="row">
        <div class="col-2">Descripcion servicio</div>
        <div class="col-2"><textarea id="descripcionservicio" class="form-control input-sm" ></textarea></div>
              <div class="col-2">Estado</div>
        <div class="col-2"><select id="Estado" class="form-control input-sm" >
        ...
        <div class="col-12" ><button  style="background-color:#071456;color:white;width:100%" onclick="generarmantenimiento();return false;" id="btnfac" >
            Grabar Mantenimiento</button></div>
    </div>
  ...
  <form  class="form-container">
    ...
    <script>
        ...
        function generarmantenimiento() {
            ...
            var Nro = document.getElementById("HiddenFieldNro").value;
            var Opcion = document.getElementById("HiddenFieldOpcion").value;
            ...
            var myData = {"mantenimiento": myData0};
            ...
            $.ajax({
                type: "POST",
                url: json_url + "/" + "GenerarMantenimiento",
                data: encoded,
        ...
        document.addEventListener("DOMContentLoaded", TraeInfoMantenimiento, false); // get_json_data is the function name that will fire on page load
